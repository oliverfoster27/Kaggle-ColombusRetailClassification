...
if __name__ == "__main__":
    ...
    full_pipeline = Pipeline(steps=[('prep', prep_pipeline),
                                    ...
                                    ('sfm', SelectFromModel(estimator=DecisionTreeClassifier(), threshold=0)),
                                    ('model', BaggingClassifier(max_features=1.0, max_samples=0.2,
                                                                n_estimators=400))])
    ...
    X_sub.to_csv(r"C:\Users\olive\Documents\GitHub\Kaggle-ColombusRetailClassification\experiments\e4.csv")